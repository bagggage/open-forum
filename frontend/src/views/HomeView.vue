<template>
  <div class="home">
    ...
    <section class="mb-4">
      ...
      <input id="search-input" v-model="searchQuery" @input="filterQuestions" placeholder="Введите ключевое слово..." class="w-full"/>
    </section>

    <section class="mb-8">
      <label for="category-select" class="block text-sm font-medium text-gray-700">Выберите категорию:</label>
      <select id="category-select" v-model="selectedCategory" @change="resetPagination" class="w-full">
